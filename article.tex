...
\begin{itemize}
 \item Keywords: mobile cloud computing models, MCC models, mobile cloud models, mobile cloud architecture, mobile cloud
...
\begin{itemize}
 \item Palavras-chave: 
modelos de computação em nuvem móvel
 Modelos MCC, modelos de nuvem móvel, arquitetura de nuvem móvel, computação em nuvem móvel, MCC, computação móvel, revisão da
 literatura na nuvem móvel, desafios de nuvem móvel, desafios.
\end{itemize}
